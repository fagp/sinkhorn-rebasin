...
from rebasin.loss import DistL2Loss
...
kernelsA = visualize_kernels(modelA.hidden[2].weight)
plt.matshow(kernelsA)
plt.axis("off")
# plt.show()
plt.savefig("alignment_mlp_modelA.png")

kernelsB = visualize_kernels(modelB.hidden[2].weight)
plt.matshow(kernelsB)
plt.axis("off")
# plt.show()
plt.savefig("alignment_mlp_modelB.png")

kernelspiA = visualize_kernels(pi_modelA().hidden[2].weight)
plt.matshow(kernelspiA)
plt.axis("off")
# plt.show()
plt.savefig("alignment_mlp_pimodelA.png")
